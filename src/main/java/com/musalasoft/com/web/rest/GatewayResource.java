...
public class GatewayResource {
    ...
    @Timed
    public ResponseEntity<Gateway> createGateway(@Valid @RequestBody Gateway gateway) throws URISyntaxException {
    ...
    @PutMapping("/gateways")
    @Timed
    public ResponseEntity<Gateway> updateGateway(@Valid @RequestBody Gateway gateway) throws URISyntaxException {
    ...
    @GetMapping("/gateways")
    @Timed
    public ResponseEntity<List<Gateway>> getAllGateways(Pageable pageable) {
        log.debug("REST request to get a page of Gateways");
        Page<Gateway> page = gatewayRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/gateways");
