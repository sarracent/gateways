...
import { PeripheralComponent } from 'app/entities/peripheral/peripheral.component';
...
describe('Component Tests', () => {
    describe('Peripheral Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.peripherals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
